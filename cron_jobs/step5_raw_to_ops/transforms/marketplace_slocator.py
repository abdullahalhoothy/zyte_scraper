...
def transformation_commercial_properties():
    ...
    SELECT 
        ...
        city_name,
        NULLIF(walking_transport_score, '')::REAL,
        NULLIF(transit_transport_score, '')::REAL,
        NULLIF(cycling_transport_score, '')::REAL,
        NULLIF(driving_transport_score, '')::REAL,
        NULLIF(primary_schools_score, '')::REAL,
        NULLIF(high_schools_score, '')::REAL,
        NULLIF(daycares_score, '')::REAL,
        NULLIF(groceries_score, '')::REAL,
        NULLIF(restaurants_score, '')::REAL,
        NULLIF(shopping_score, '')::REAL,
        NULLIF(cafes_score, '')::REAL,
        NULLIF(quiet_score, '')::REAL,
        NULLIF(nightlife_score, '')::REAL,
        NULLIF(vibrant_score, '')::REAL,
        NULLIF(historic_score, '')::REAL,
        NULLIF(parks_score, '')::REAL,
        NULLIF(greenery_score, '')::REAL,
        age,
        incomes,
        household,
        family,
