...
def process_census_data(level):
    ...
    try:
        ...
        os.makedirs(f'household_json_files/v{level}', exist_ok=True)
        ...
        with open(f'household_json_files/v{level}/all_features.json', 'w') as f:
...
def main():
    ...
    if all_features:
        ...
        logging.info("- Individual JSON files in 'household_json_files/v{level}' directories")
