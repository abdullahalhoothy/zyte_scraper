...
from downloading_household_files import download_json_files_recursive
...
def process_census_data(level):
    ...
    base_url = f"https://maps.saudicensus.sa/arcgis/rest/services/results_grid_hh_v{level}/FeatureServer/0/query"
    params = {
        'where': '1=1',
        'outFields': '*',
        'returnGeometry': 'true',
    ...
    try:
        ...
        json_files_path = os.path.join(MODULE_DIR, "household_json_files")
        ...
        for feature in features:
            ...
            processed_feature = {
                ...
                'HHAVG': feature['properties'].get('HHAVG'),
                'HHMED': feature['properties'].get('HHMED'),
        ...
        json_files_path = os.path.join(MODULE_DIR, "household_json_files")
        with open(f'{json_files_path}/v{level}/features.json', 'w') as f:
...
def main():
    ...
    if all_features:
        ...
        # save_to_csv(all_features, 'household.csv', csv_fields)
        ...
        logging.info("- Combined data in 'household.csv'")
        success=True
...
if __name__ == "__main__":
    try:
        ...
        if not success:
            ...
            source_prefix = "postgreSQL/dbo_operational/raw_schema_marketplace/household/20250529/household_json_files"
